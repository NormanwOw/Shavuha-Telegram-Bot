MAIN_PAGE = '<b>За углом втихаря</b> 🌮\n\n' \
            ...
            'его приготовлению. Забрать заказ вы можете по адресу г.Пермь, ' \
            'ул.Куйбышева 147/1.\n\n' \
...
SET_TIME_MESSAGE = '<b>⏱ Время</b>\n\n' \
                   ...
                   '   <b>Это необязательно</b>. Без установки времени после оплаты мы сразу' \
...
EMPLOYEE_HELP = '\n\n   Для подключения сотрудника к боту сообщите ему ' \
                '<b>пароль для персонала</b>. Далее, ему необходимо ввести команду ' \
                '<b>/personal</b> на главной странице этого бота, после чего воспользоваться ' \
...
PAUSE_MESSAGE = 'Приём заказов временно приостановлен'

MAILS_TITLE = '📨 <b>Рассылки</b>'
MAILS_HELP = '\n\nВ этом разделе вы можете создать сообщение для всех ваших клиентов, ' \
             'оформивших заказ'
SEND_MAIL = 'Вы уверены что хотите отправить клиентам это сообщение?\n\n'
